...
const AkrepBurcu = () => {
    ...
    const horoscopeData = {
        date: '27 Aralık 2024',
        dailyHoroscope: 'Sezgilerinizin güçlü olduğu bir gün. Gizemli konulara ilginiz artabilir. Derin araştırmalar yapma konusunda başarılı olacaksınız.',
        love: 'Duygusal bağlarınız derinleşebilir. Tutkulu ve yoğun duygular yaşayabilirsiniz.',
        career: 'İş hayatında stratejik kararlar almanız gerekebilir. Araştırma gerektiren konularda başarılı olacaksınız.',
        health: 'İç huzurunuza önem verin. Meditasyon size iyi gelebilir.',
        luckyNumber: '9',
        luckyColor: 'Bordo',
            ...
            <Grid container spacing={3}>
                <Grid item xs={12}>
                    <Box display="flex" alignItems="center" gap={2}>
                        ...
                        <Typography variant="h2">Akrep Burcu Günlük Yorumu</Typography>
                    </Box>
