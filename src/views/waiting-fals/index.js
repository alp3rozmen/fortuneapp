      ...
      <Box sx={{ p: 2, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        {props.comment &&
          <CustomDialog
            ...
            <Box sx={{ width: { xs: '100%', sm: '500px' }, p: 2, display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, justifyContent: 'center' }}>
              <Box>
                <Input sx={{ width: { xs: '100%', sm: '450px' }, border: '1px solid black', padding: '10px', borderRadius: '10px' }} disableUnderline readOnly multiline rows={4} value={props.comment} />
              </Box>
            </Box>
          </CustomDialog>
        }
