            ...
            <>
              {userDetails.length === 0 ? (
                ...
                userDetails.map((userDetail) => (
                  <Box sx={{ gridTemplateColumns: 'repeat(4, 1fr)', mt: 2, justifyContent: 'center', width: { xs: '100%', sm: 'auto' } }} key={userDetail.id}>
                    <Card id={userDetail.id} key={userDetail.id} sx={{ display: 'flex', mr: { xs: 0, sm: 2 }, mb: { xs: 2, sm: 0 }, boxShadow: 3, maxWidth: 230, width: { xs: '100%', sm: 230 } }}>
